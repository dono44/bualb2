            ...
            <div className="space-y-3">
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800">
                ...
                <ol className="list-decimal list-inside space-y-2 text-slate-300">
                  ...
                  <li>
                    Dans l'application DualAudio Studio, attribuez <strong>Périphérique A</strong> au premier casque et <strong>Périphérique B</strong> au deuxième casque.
                  </li>
                  <li>
            ...
            <div className="space-y-3">
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800">
                ...
                <ol className="list-decimal list-inside space-y-2 text-slate-300">
                  ...
                  <li>Dans DualAudio Studio, votre périphérique combiné apparaîtra directement avec le contrôle fluide du volume individuel.</li>
                </ol>
              </div>
            </div>
          )}
