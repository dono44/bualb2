        ...
        <div className="flex-1 space-y-3">
          ...
          <div>
            <h3 className="text-base font-bold text-white flex items-center gap-2">
              Double Diffusion Audio pour Android & Samsung Galaxy
            </h3>
            <p className="text-xs text-slate-300 leading-relaxed mt-1">
              Diffusez votre musique sur deux enceintes ou écouteurs Bluetooth en même temps. Activez le partage audio Android et synchronisez le délai pour un son parfaitement calé.
            </p>
          </div>
